...
Files: macbook-16.glb [639.28KB] > D:\project\MacGO\public\models\macbook-16-transformed.glb [629.72KB] (1%)
...
import useYourStore from "../../store/index.js";

export default function MacModel16(props) {
  const { nodes, materials, scene } = useGLTF('/models/macbook-16-transformed.glb');
  const texture = useTexture('/screen.png');
  const { color } = useYourStore();
